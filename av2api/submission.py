...
PredictionRow = Tuple[str, int, str, float, PredictedTrajectories, PredictionProbabilities]
...
class ChallengeSubmission:
    ...
    def from_parquet(cls, submission_file_path: Path) -> ChallengeSubmission:
        ...
        for (scenario_id, timestep, track_id), track_df in submission_df.groupby(["scenario_id", "timestep", "track_id"]):
