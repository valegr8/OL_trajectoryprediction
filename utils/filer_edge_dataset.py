...
destination_folder = "/home/vgrwbx/workspace/OL_trajectoryprediction/data/olval/raw"

ids_to_keep = set() 
# # Read IDs from file
with open('/home/vgrwbx/workspace/OL_trajectoryprediction/metrics_files/above_threshold_samples.csv', 'r') as file:
...
destination_folder = "/home/vgrwbx/workspace/OL_trajectoryprediction/data/olval/processed/"
copy_dataset(source_folder, destination_folder, ids_to_keep)
